...
image:https://img.shields.io/travis/riboseinc/isobib/master.svg["Build Status", link="https://travis-ci.com/riboseinc/isobib"]
...
Bug reports and pull requests are welcome on GitHub at https://github.com/riboseinc/isobib
